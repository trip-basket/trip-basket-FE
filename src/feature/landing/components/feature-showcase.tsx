    ...
    <section className="py-24 lg:py-32 px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <Text variant="body" color="soft" className="mt-2">
            4단계로 완벽한 여행 일정을 만들어 보세요.
          </Text>
        </div>

        <div className="flex flex-col sm:flex-row gap-3" role="tablist">
          {features.map((feature, index) => {
            const isActive = index === activeIndex;
            return (
              <div className="relative flex-1" key={feature.title}>
                {/* Active state (yellow background, revealed by clip-path) */}
                {isActive && (
                  <div className="relative rounded-card p-4 text-left bg-amber-50">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center gap-2 mb-2">
                        <Text variant="caption" weight="bold" className="text-amber-600">
                          {feature.number}
                        </Text>
                ...
                {/* Default state (white, clip-path hides over time) */}
                <button
                  type="button"
                  role="tab"
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-2">
                      <Text as="span" variant="caption" weight="bold" color="muted">
                        {feature.number}
                      </Text>
        ...
        {/* Demo area — 영상/스크린샷 자리 */}
        <div className="relative mt-6 rounded-container bg-white aspect-video flex items-center justify-center">
          <DashedBorder radius={16} />
