...
/**
 * Renders the sticky header row of day columns for the trip and provides controls to insert days before or after the range.
 *
 * Displays each day's day-of-week and date number; when a day's total blocks cost is greater than zero, shows the total formatted using the current room currency.
 *
 * @param ref - Forwarded ref attached to the header container div
 * @returns The header row element containing day columns and add-day controls
 */
